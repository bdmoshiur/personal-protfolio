  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Manage Eduction </h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Eduction </li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
          ...
          <section class="col-md-12">
            ...
            <div class="card">
              <div class="card-header">
                    <h3>
                        Add Education
                        <a class="btn btn-success float-right btn-sm"  href="{{ route('educations.view') }}"><i class="fa fa-list"></i> Eduction List</a>
                    </h3>
              </div><!-- /.card-header -->
              <div class="card-body">
                <form action="{{ route('educations.store') }}" method="POST" id="myForm" enctype="multipart/form-data">
                    @csrf
