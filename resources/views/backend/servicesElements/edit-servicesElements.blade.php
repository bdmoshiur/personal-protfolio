        ...
        <div class="row">
          ...
          <section class="col-md-12">
            ...
            <div class="card">
              ...
              <div class="card-body">
                <form action="{{ route('servicesElements.update',$editData->id) }}" method="post" id="myForm" enctype="multipart/form-data">
                    @csrf
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <textarea class="form-control{{ $errors->has('meta_descriptions') ? ' is-invalid' : '' }}" name="meta_descriptions" id="" cols="30" rows="5">{{ $editData->meta_descriptions }}</textarea>
